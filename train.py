...
if __name__ == '__main__':
    ...
    training_data.lidar_data = np.expand_dims(training_data.lidar_data, 1)
    ...
    test_data.lidar_data = np.expand_dims(test_data.lidar_data, 1)
    ...
    model.compile(optimizer=optim, loss=loss_fn, metrics=[top1])
